...
# On Linux servers: always show user@hostname in prompt, even outside SSH/tmux.
# The p10k config hides context by default on non-SSH sessions — override that here.
